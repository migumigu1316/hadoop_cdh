 ...
 * 作者姓名 修改时间 版本号 描述
 */
package ETL.com.xdjy.map_side.answer_exam_question;
...
public class MyMapJoin {
    // 定义输入路径
    private static String INPUT_PATH1 = "hdfs://192.168.198.60:9000/xdjy/result/answer_exam/answer_exam.log";
    //加载到内存的表的路径
    private static String INPUT_PATH2 = "hdfs://192.168.198.60:9000/xdjy/question/question.log";
    // 定义输出路径
    private static String OUT_PATH = "hdfs://192.168.198.60:9000/xdjy/result/answer_exam_question";
...
// 提交作业 退出
    ...
    public static class MapJoinMapper extends Mapper<LongWritable, Text, Text, NullWritable> {
        ...
        protected void setup(Context context) throws IOException, InterruptedException {
            ...
            try {
                ...
                while ((str = reader.readLine()) != null) {
                    ...
                    // 把字符数组中有用的数据存在一个Map中
                    String m_res = splits[1] + "+" + splits[2] + "+" + splits[3];
                    joinData.put(Integer.parseInt(splits[0]), m_res);

                    System.out.println("m_res = " + m_res);
                }
            } catch (Exception e) {
                e.printStackTrace();
            } finally {
        ...
        protected void map(LongWritable key, Text value, Context context) throws IOException,
            ...
            // 获取关联字段depNo，这个字段是关键
            int question_id = Integer.parseInt(values[9]);

            // 根据depNo从内存中的关联表中获取要关联的属性depName
            String res = joinData.get(question_id);
