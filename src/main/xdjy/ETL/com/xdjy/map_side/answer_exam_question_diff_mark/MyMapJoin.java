 ...
 * 作者姓名 修改时间 版本号 描述
 */
package ETL.com.xdjy.map_side.answer_exam_question_diff_mark;
...
public class MyMapJoin {
    // 定义输入路径
    private static String INPUT_PATH1 = "hdfs://192.168.198.60:9000/xdjy/result/answer_exam_question_diff/answer_exam_question_diff.log";
    //加载到内存的表的路径
    private static String INPUT_PATH2 = "hdfs://192.168.198.60:9000/xdjy/paper_template_part/paper_template_part.log";
    // 定义输出路径
    private static String OUT_PATH = "hdfs://192.168.198.60:9000/xdjy/result/answer_exam_question_diff_mark";
...
//
// 获取关联字段depNo，这个字段是关键
            String temp_type = values[11] + values[14];
