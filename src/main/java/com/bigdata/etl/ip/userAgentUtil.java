        ...
        if(StringUtils.isNotEmpty(userAgent)){
            try {
                ...
                if (userAgentInfo != null){
                    ...
                    info.setBrowserName(userAgentInfo.getUaFamily());//获取浏览器名称
                    info.setBrowserVersion(userAgentInfo.getBrowserVersionInfo());//浏览器版本
                    info.setOsName(userAgentInfo.getOsFamily());//获取操作系统
                    info.setOsVersion(userAgentInfo.getOsName());//获取操作系统版本
                }
            } catch (IOException e) {
