...
///**
// * @ClassName: TotalUserRunner
// * @Description: TODO 总用户的驱动类
// * @Author: xqg
...
// */
//
//public class TotalUserRunner implements Tool {
//    private static final Logger logger = Logger.getLogger(TotalUserRunner.class);
//    private Configuration conf = new Configuration();
//
//    //主函数---入口
//    public static void main(String[] args){
//        try {
//            ToolRunner.run(new Configuration(),new TotalUserRunner(),args);
//        } catch (Exception e) {
...
//
//        job.setJarByClass(TotalUserRunner.class);
//
//        //设置map相关参数
