...
//
///**
// * @ClassName: BrowserNewMemberOutputWriter
// * @Description: TODO  〈一句话功能简述〉<br>〈对于不同的指标，这列赋值都是不一样的〉
// * @Author: xqg
// * @Date: 2018/11/7 15:10
// */
//public class BrowserNewMemberOutputWriter implements IOutputWriter {
//    private static final Logger logger = Logger.getLogger(BrowserNewMemberOutputWriter.class);
//
//    @Override
