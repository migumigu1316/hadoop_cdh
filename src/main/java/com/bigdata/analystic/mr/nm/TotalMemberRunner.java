...
//import com.bigdata.analystic.mr.nu.NewUserMapper;
//import com.bigdata.analystic.mr.nu.NewUserReducer;
...
//
///**
// * @ClassName: TotalMemberRunner
// * @Description: TODO 总会员的驱动类
// * @Author: xqg
...
// */
//
//public class TotalMemberRunner implements Tool {
//    private static final Logger logger = Logger.getLogger(TotalMemberRunner.class);
//    private Configuration conf = new Configuration();
//
//    //主函数---入口
//    public static void main(String[] args){
//        try {
//            ToolRunner.run(new Configuration(),new TotalMemberRunner(),args);
//        } catch (Exception e) {
...
//
//        Job job = Job.getInstance(conf,"MEMBER TO MYSQL");
//
//        job.setJarByClass(TotalMemberRunner.class);
//
//        //设置map相关参数
...
//            Path inpath = new Path("/ods/11/04/");
//            if(fs.exists(inpath)){
