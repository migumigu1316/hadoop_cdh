...
import com.bigdata.analystic.mr.am.ActiveMemberMapper;
import com.bigdata.analystic.mr.am.ActiveMemberReducer;
...
public class SessionRunner implements Tool {
    ...
    public static void main(String[] args) {
        try {
            ...
            logger.warn("SESSIONS TO MYSQL is failed !!!", e);
        }
    }
...
//        conf.set(GlobalConstants.RUNNING_DATE,date);
        ...
        Job job = Job.getInstance(conf, "SESSIONS TO MYSQL");
